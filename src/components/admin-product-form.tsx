...
export function AdminProductForm({ families, initialFamilyId = "", isRv = false }: { families: ProductFamilyDTO[]; initialFamilyId?: string; isRv?: boolean }) {
