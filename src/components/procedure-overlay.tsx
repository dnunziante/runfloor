...
export function ProcedureOverlay({ title, onClose, children, drawer = false, compact = false }: { title: string; onClose: () => void; children: ReactNode; drawer?: boolean; compact?: boolean }) {
