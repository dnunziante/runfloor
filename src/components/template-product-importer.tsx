...
function yearLabel(item: Candidate) {
  const suppliedLabel = item.specifications.modelYearLabel;
  return item.modelYear || (typeof suppliedLabel === "string" && suppliedLabel.trim() ? suppliedLabel : "Year not supplied");
}
