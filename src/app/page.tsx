...
export default function Home() {
  return <main className="lp">
    <section className="lp-hero">
      <header className="lp-nav"><Link href="/" aria-label="RunFloor home"><BrandLogo priority/></Link><nav><details><summary>Platform <ChevronDown/></summary><div><a href="#platform">Platform overview</a><a href="#solutions">Solutions</a></div></details><details><summary>Solutions <ChevronDown/></summary><div><Link href="/assistant">Sales Assistant</Link><Link href="/operations">Operations</Link><Link href="/coach">Coaching</Link><Link href="/executive">Executive</Link></div></details><a href="#resources">Resources</a><a href="#pricing">Pricing</a></nav><div><Link href="/demo">View Demo</Link><Link className="lp-button" href="/login">Log In <ArrowRight/></Link></div></header>
